...
if nargin==4 && any(strcmpi({'v','vis','visual','visualize','visualization'},dv))
    ...
    if sP(2) == 2
        ...
        title(['Hausdorff Distance = ' num2str(m)], 'FontSize', 25, 'FontWeight', 'bold')
    ...
    elseif sP(2) == 3
        ...
        uistack(fliplr(h),'top')
        xlabel('Dim 1', 'FontSize', 30, 'FontWeight', 'bold'); 
        ylabel('Dim 2', 'FontSize', 30, 'FontWeight', 'bold'); 
        zlabel('Dim 3', 'FontSize', 30, 'FontWeight', 'bold');
        title(['Hausdorff Distance = ' num2str(m)], 'FontSize', 25, 'FontWeight','bold')
        legend(h,{'P','Q','Hausdorff Dist'},'location','best')
    ...
    xlabel('ordered points in Q (o)', 'FontSize', 15, 'FontWeight', 'bold')
    ylabel('ordered points in P (x)', 'FontSize', 15, 'FontWeight', 'bold')
