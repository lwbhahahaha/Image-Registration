function [hF,hB] = imoverlay(B,F,heartBW,BB,climF,climB,cmap,alpha,haxes)
...
%%Testing: comment the bounding box (BB)  
B=B(BB(2):(BB(2)+BB(5)-1),BB(1):(BB(1)+BB(4)-1));
...
%%Testing: comment the bounding box (BB)  
F=F(BB(2):(BB(2)+BB(5)-1),BB(1):(BB(1)+BB(4)-1));
...
%%Testing: comment the bounding box (BB)  
A=heartBW((BB(2):(BB(2)+BB(5)-1)),BB(1):(BB(1)+BB(4)-1));
