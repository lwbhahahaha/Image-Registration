% This is just a version of imtool3D that should work in R2019. It was a
% quick fix, might have issues. -Connor
...
classdef imtool3D2 < handle
    ...
    methods
        ...
        function tool = imtool3D2(varargin)  %Constructor
            ...
            cellarr = struct2cell(tool.handles.Panels);
            set([cellarr{:}],'BackgroundColor','k','ForegroundColor','w','HighlightColor','k');
            ...
            cellarr = struct2cell(tool.handles.Tools);
            set([cellarr{:}],'FontSize',9,'Units','Pixels')
