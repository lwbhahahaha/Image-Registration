function Call_Niftyreg(program, target_nii, floating_nii, in_dir, out_dir, more_opts)
...
% program is ran on.
% ***********************************
nifty_reg_path  = 'C:\Programs\NiftyReg\bin';
...
opts_string = [' -ref ' ['"' in_dir target_nii '"'] ' -flo ' ['"' in_dir floating_nii '"'] ...
