...
char xml_f3d[] =
   ...
   "      <description>Padding value [nan]</description>\n"
   "      <label>Padding value</label>\n"
   "      <default></default>\n"
   "    </float>\n"
   "  </parameters>\n"
   "  <parameters advanced=\"true\">\n"
   "    <label>Regularisation options</label>\n"
   "    <description>Regularisation options</description>\n"
   "    <float>\n"
   ...
   "    </float>\n"
   "    <float>\n"
   "      <name>FirstOrderPenaltyTermWeight</name>\n"
   "      <longflag>le</longflag>\n"
   "      <description>Weight of first order penalty term (symmetric and anti-symmetric part of the Jacobian)</description>\n"
   "      <label>First order weight</label>\n"
   ...
   "  </parameters>\n"
   "  <parameters advanced=\"true\">\n"
   "    <label>Similarity measure options</label>\n"
   "    <description>Similarity measure options</description>\n"
   "    <boolean>\n"
   "      <name>UseNMI</name>\n"
   ...
   "    </boolean>\n"
   "    <boolean>\n"
   "      <name>UseUnNormSSD</name>\n"
   "      <longflag>ssdn</longflag>\n"
   "      <description>Used for all time points - images are NOT normalized between 0 and 1 before computing the measure</description>\n"
   "      <label>Use unnormalized SSD</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <float>\n"
   "      <name>UseLNCC</name>\n"
   ...
   "    <integer>\n"
   "      <name>UseMIND</name>\n"
   "      <longflag>mind</longflag>\n"
   "      <description>MIND and the offset to use to compute the descriptor</description>\n"
   "      <label>Use MIND</label>\n"
   "      <default>-999999</default>\n"
   "    </integer>\n"
   "    <integer>\n"
   "      <name>UseMINDSSC</name>\n"
   "      <longflag>mindssc</longflag>\n"
   "      <description>MIND-SCC and the offset to use to compute the descriptor</description>\n"
   "      <label>Use MIND-SCC</label>\n"
   "      <default>-999999</default>\n"
   "    </integer>\n"
   "    <boolean>\n"
   "      <name>RemoveOutliers</name>\n"
   "      <longflag>rr</longflag>\n"
   "      <description>Intensities are thresholded between the 2 and 98% ile</description>\n"
   ...
   "    </boolean>\n"
   "    <float>\n"
   "      <name>UseSmoothGrad</name>\n"
   "      <longflag>smoothGrad</longflag>\n"
   "      <description>To smooth the metric derivative (in mm)</description>\n"
   "      <label>Smooth Gradient</label>\n"
   "      <default>0</default>\n"
   "    </float>\n"
   "    <integer>\n"
   "      <name>perterbation</name>\n"
   "      <longflag>pert</longflag>\n"
   "      <description>Add perturbation step(s) after each optimisation scheme</description>\n"
   "      <label>Perterbation Steps</label>\n"
   "      <default>0</default>\n"
   "      <constraints>\n"
   "        <minimum>0</minimum>\n"
   "        <maximum>100</maximum>\n"
   ...
   "      <description>Use a velocity field integration to generate the deformation</description>\n"
   "      <label>Use Velocity</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <boolean>\n"
   "      <name>noConjGrad</name>\n"
   "      <longflag>nogce</longflag>\n"
   "      <description>Do not use the gradient accumulation through exponentiation</description>\n"
   "      <label>No Conjugate Gradient</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <image fileExtensions=\".nii,.nii.gz,.nrrd,.png\">"
