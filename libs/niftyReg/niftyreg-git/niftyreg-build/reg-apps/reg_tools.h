...
char xml_tools[] =
   ...
   "    </boolean>\n"
   "    <boolean>\n"
   "      <name>createMIND</name>\n"
   "      <longflag>mind</longflag>\n"
   "      <description>Create a MIND descriptor image</description>\n"
   "      <label>Create MIND descriptor</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <boolean>\n"
   "      <name>createMIND-SSC</name>\n"
   "      <longflag>mindssc</longflag>\n"
   "      <description>Create a MIND-SSC descriptor image</description>\n"
   "      <label>Create MIND-SSC descriptor</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <boolean>\n"
   "      <name>ActiveBlocks</name>\n"
   "      <longflag>testActiveBlocks</longflag>\n"
   "      <description>Generate an image highlighting the active blocks for reg_aladin (block variance is shown)</description>\n"
   "      <label>Create active blocks</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <boolean>\n"
   ...
   "    </boolean>\n"
   "    <float-vector>\n"
   "      <name>resampleMM</name>\n"
   "      <longflag>chgres</longflag>\n"
   "      <description>Resample the input image to the specified resolution (in mm)</description>\n"
   "      <label>Resample image (mm)</label>\n"
   "      <default></default>\n"
   "    </float-vector>\n"
   "    <integer-enumeration>\n"
   "      <name>interpolation</name>\n"
   "      <longflag>interp</longflag>\n"
   "      <description>Interpolation order to use to resample the image</description>\n"
   ...
   "    <boolean>\n"
   "      <name>noScale</name>\n"
   "      <longflag>noscl</longflag>\n"
   "      <description>Scale slope is set to 1 and scale intercept is set to 0.</description>\n"
   "      <label>No scaling</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <float>\n"
   "      <name>replaceNaN</name>\n"
   "      <longflag>rmNanInf</longflag>\n"
   "      <description>Remove the nan and inf from the input image and replace them by the specified value</description>\n"
   "      <label>Replace NaN and Inf</label>\n"
   ...
   "    <float-vector>\n"
   "      <name>smooth</name>\n"
   "      <longflag>smoL</longflag>\n"
   "      <description>The input label image is smoothed using Gaussian kernel</description>\n"
   "      <label>Smooth Label (Guassian)</label>\n"
   "      <default></default>\n"
   "    </float-vector>\n"
   "    <float-vector>\n"
   "      <name>smooth</name>\n"
   ...
   "      <label>Smooth Image (Gaussian)</label>\n"
   "      <default></default>\n"
   "    </float-vector>\n"
   "    <float>\n"
   "      <name>threshold</name>\n"
