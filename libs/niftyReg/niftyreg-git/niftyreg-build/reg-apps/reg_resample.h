...
char xml_resample[] =
   ...
   "    </integer-enumeration>\n"
   "    <boolean>\n"
   "      <name>psfResample</name>\n"
   "      <longflag>psf</longflag>\n"
   "      <description>Perform the resampling in two steps to resample an image to a lower resolution</description>\n"
   "      <label>Point-spread function resampling</label>\n"
   "      <default>false</default>\n"
   "    </boolean>\n"
   "    <integer-enumeration>\n"
   "      <name>psfResampleType</name>\n"
   "      <longflag>psf_alg</longflag>\n"
   "      <description>Minimise the matrix metric (0) or the determinant (1) when estimating the PSF</description>\n"
   "      <label>Point-spread function type</label>\n"
   "      <default>0</default>\n"
   "      <element>0</element>\n"
   "      <element>1</element>\n"
   "    </integer-enumeration>\n"
   ...
   "    <description>Advanced parameters for resampling the image</description>\n"
   "    <float>\n"
